...
?>
    ...
    <!---------- single product details ---------->
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Red_cotton.jpg" width="100%" id="ProductImg">
                    
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Red_cotton2.jpg" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Red_cotton3.jpg" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Red_cotton5.jpg" width="100%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Red_cotton.jpg" width="100%" class="small-img">
                        </div>
                    </div>
                ...
                <div class="col-2">
                    ...
                    <br>
                    <h1>Red color cotton saree by our own production!</h1><br>
                    
                    <h4>&#8377;999</h4>
                    <input type="number" value="1"> 
                    <a href="check.php"class="btn">Add To Cart</a>
    ...
    <!----------products--------->
        <div class="small-container">
            ...
            <div class="row">
                <div class="col-4">
                    <a href="product-details.php"><img src="images/product1.webp"></a>
                    <h4>Red saree</h4>
                    <div class="checked">
